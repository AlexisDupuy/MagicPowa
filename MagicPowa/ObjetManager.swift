...
class ObjetManager {
    var objetArray:[Objet] = [
        ...
        Objet(name: "Fortifications", category: "Type de carte", type: "article", contenu: "Certains artefacts ont le sous-type « fortification ». Une fortification peut être attachée à un terrain et possède les même caractéristiques qu'un équipement. ", titre: "Fortifications"),
