...
class ObjetManager {
    var objetArray:[Objet] = [
        ...
        Objet(name: "Artefacts", category: "Type de carte", type: "article", contenu: "Un joueur qui a la priorité peut lancer une carte d'artefact depuis sa main, pendant la phase principale de son tour. Quand un sort d'artefact se résout, son contrôleur met l'artefact sur le champ de bataille, sous son contrôle. La plupart des artefacts sont incolores. Cependant, il n'y a aucun lien entre le fait d'être incolore et le fait d'être un artefact. Des artefacts peuvent avoir une ou plusieurs couleurs, et des objets incolores peuvent ne pas être des artefacts.", titre: "Artefacts"),
        Objet(name: "Equipements", category: "Type de carte", type: "article", contenu: "Certains artefacts ont le sous-type « équipement. »  Un équipement est lancé et arrive sur le champ de bataille tout comme n'importe quel autre artefact. La capacité mot-clé « équipement » attache l'équipement à une créature que vous contrôlez. L'identité du contrôleur de la créature n'a d'importance que lorsque la capacité « équipement » est activée et lorsqu'elle se résout. Des sorts ou des capacités peuvent également attacher des équipements à des créatures. Si un effet tente d'attacher un équipement à un objet auquel il ne peut pas être attaché, alors l'équipement ne bouge pas. Un équipement équipant un permanent qui n'existe plus se détache de ce permanent, mais reste sur le champ de bataille. Il n'y a aucun lien entre le contrôleur d'un équipement et le contrôleur de la créature équipée. Seul le contrôleur de l'équipement peut activer ses capacités.", titre: "Equipements"),
        Objet(name: "Fortifications", category: "Type de carte", type: "article", contenu: "CCertains artefacts ont le sous-type « fortification ». Une fortification peut être attachée à un terrain et possède les même caractéristiques qu'un équipement. ", titre: "Fortifications"),
